...
const DICT: Record<string, [string, string]> = {
  ...
  "Learn with this question": ["用这道题学习", "Aprender con esta pregunta"],
  "Watch AI × AI Q&A": ["观摩 AI 问答", "Ver P&R entre IA"],
  "AI × AI Q&A": ["AI 问答观摩", "P&R entre IA"],
  "Asker": ["提问 AI", "IA que pregunta"],
  "Answerer": ["回答 AI", "IA que responde"],
  "Play": ["播放", "Reproducir"],
  "Pause": ["暂停", "Pausa"],
